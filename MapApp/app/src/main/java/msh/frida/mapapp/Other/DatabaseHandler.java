...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    // Adding new hike
    public long addHike(HikeModel hike) {
        ...
        values.put(KEY_USER_ID, hike.getUserId());
    ...
    public HikeModel getHike(int id) {
        ...
        Cursor cursor = db.query(TABLE_HIKES,
                new String[] { KEY_ID, KEY_TITLE, KEY_NAME, KEY_PARTICIPANTS, KEY_WEATHER, KEY_DESCRIPTION, KEY_START_DATE,
                        KEY_END_DATE, KEY_MAP_FILE, KEY_DISTANCE, KEY_USER_ID, KEY_OBSERVATION_POINTS, KEY_TRACK_POINTS },
                KEY_ID + "=?",
        ...
        String cursorObservation = cursor.getString(11);
        String cursorTrack = cursor.getString(12);
        ...
        HikeModel hike = new HikeModel(Integer.parseInt(cursor.getString(0)), cursor.getString(1), cursor.getString(2),
                ...
                Long.valueOf(cursor.getString(7)), cursor.getString(8), cursor.getDouble(9), cursor.getString(10), observationList, trackList);
        return hike;
    }
    ...
    public List<HikeModel> getAllHikes() {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                hike.setUserId(cursor.getString(12));
